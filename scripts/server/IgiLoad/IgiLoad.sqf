...
if (isnil "IL_Variables") then
{
	...
	IL_Supported_Vehicles_CHINOOK = ["RHS_CH_47F", "RHS_CH_47F_10", "kyo_MH47E_HC", "kyo_MH47E_Ramp", "kyo_MH47E_base",];
	...
	IL_Supported_Supply_Crate = ["B_supplyCrate_F", "rhsusf_spec_weapons_crate", "rhsusf_weapon_crate", "rhsusf_launcher_crate", "rhsusf_mags_crate", "rhsusf_gear_crate"];
